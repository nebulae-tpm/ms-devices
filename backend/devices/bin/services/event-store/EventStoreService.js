  ...
  subscribeEventHandler({
    ...
    const subscription =
      ...
      eventSourcing.eventStore
        ...
        .mergeMap(() =>
          eventSourcing.eventStore.getEventListener$(aggregateType)
        )
        ...
        .mergeMap(evt =>
          Rx.Observable.concat(
            ...
            eventSourcing.eventStore.acknowledgeEvent$(
              evt,
              'ms-devices_mbe_devices'
            )
          )
        )
        .subscribe(evt => {}, onErrorHandler, onCompleteHandler);
