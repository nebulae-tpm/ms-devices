...
class EventStoreService {
  ...
  generateFunctionMap() {
    return {
      ...
      DeviceNetworkStateReported: {
        fn: deviceEventConsumer.handleDeviceEventReported$,
        obj: deviceEventConsumer
      },
      ...
      DeviceRamuUsageAlarmActivated: {
        fn: deviceEventConsumer.handleDeviceAlarmReported$,
        obj: deviceEventConsumer
      },
      ...
      DeviceLowVoltageAlarmReported: {
        fn: deviceEventConsumer.handleDeviceVoltageAlarmReported$,
        obj: deviceEventConsumer
      },
      ...
      CleanDevicesHistoryJobTriggered: {
        fn: deviceEventConsumer.removeAllObsoleteMongoDocuments$,
        obj: deviceEventConsumer
      }
    };
  }
  ...
  generateAggregateEventsArray() {
    return [
      ...
      { aggregateType: 'Cronjob', eventType: 'CleanDevicesHistoryJobTriggered' }
    ];
  }
}
